...
class ChatMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chat_message" do
    assert_difference('ChatMessage.count') do
      post chat_messages_url, params: { chat_message: { body: @chat_message.body, fromable_id: @chat_message.fromable_id, fromable_type: @chat_message.fromable_type, ownerable_id: @chat_message.ownerable_id, ownerable_type: @chat_message.ownerable_type, parent_id: @chat_message.parent_id } }
    end
  ...
  test "should update chat_message" do
    patch chat_message_url(@chat_message), params: { chat_message: { body: @chat_message.body, fromable_id: @chat_message.fromable_id, fromable_type: @chat_message.fromable_type, ownerable_id: @chat_message.ownerable_id, ownerable_type: @chat_message.ownerable_type, parent_id: @chat_message.parent_id } }
