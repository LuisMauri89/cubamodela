...
class NationalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nationality" do
    assert_difference('Nationality.count') do
      post nationalities_url, params: { nationality: { name_en: @nationality.name_en, name_es: @nationality.name_es } }
    end
  ...
  test "should update nationality" do
    patch nationality_url(@nationality), params: { nationality: { name_en: @nationality.name_en, name_es: @nationality.name_es } }
