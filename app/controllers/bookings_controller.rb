class BookingsController < ApplicationController
    ...
    def booking_params
      params.require(:booking).permit(:payment, :description_en, :description_es, :location_en, :location_es, :casting_date, :shooting_date, :is_direct, :status, :profile_model_id)
    end
end
