class CastingsController < ApplicationController
  ...
  def update
      ...
      @casting.assign_attributes(casting_params)
  ...
  def confirm
    @intent = @casting.try_confirm_to_apply!(@profile)
    @from = params[:from]
  ...
  private
    ...
    def casting_params
      params.require(:casting).permit(:payment_per_model, :title_en, :title_es, :description_en, :description_es, :location_en, :location_es, :expiration_date, :casting_date, :shooting_date, :is_direct, :access_type, modality_ids:[], category_ids:[])
    end
end
